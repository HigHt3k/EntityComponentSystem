...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{res/implementation/flow charts/ECSBlockDiagram}
...
\subsubsection{Input Handling}\label{subsubsec:input-handling}
...
\end{center}\label{fig:markov-simplex}
