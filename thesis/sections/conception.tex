...
The game loop is the main thread of the game that is iterated through.
It always executes different functions in a specified order, which is in the scope of this work the following:
\todo{add list}
- handle inputs
- handle systems
- update scenes (which updates entities \& components)
- render entities
- sound system
