...
import de.unistuttgart.ils.aircraftsystemsarchitect.game.action.GridSizeYAction;
...
public class NumberChooserY extends Entity {
    ...
    public NumberChooserY(String name, int id, BufferedImage img, int x, int y, int width,
        ...
        actionComponent.addAction(MouseEvent.BUTTON1, new GridSizeYAction(i, amount));
    }
}
